export enum Translations {
  ...
  PROFILE_SECTION_PRIVACY = 'profileSectionPrivacy',
  PROFILE_SECTION_ACCOUNT = 'profileSectionAccount',
  PROFILE_THEME_FOLLOWING_DARK = 'profileThemeFollowingDark',
  PROFILE_THEME_FOLLOWING_LIGHT = 'profileThemeFollowingLight',
  PROFILE_THEME_ALWAYS_LIGHT = 'profileThemeAlwaysLight',
  PROFILE_THEME_ALWAYS_DARK = 'profileThemeAlwaysDark',
  PROFILE_BLOCKED_HINT = 'profileBlockedHint',
  PROFILE_APP_VERSION = 'profileAppVersion',
  ...
  PROFILE_SECTION_BELIEFS = 'profileSectionBeliefs',
  PROFILE_BELIEFS_NOTE = 'profileBeliefsNote',
  ...
  POLITICS_CENTRE_RIGHT = 'politicsCentreRight',
  POLITICS_RIGHT = 'politicsRight',
  POLITICS_APOLITICAL = 'politicsApolitical',
  RELIGION_AGNOSTIC = 'religionAgnostic',
  RELIGION_ATHEIST = 'religionAtheist',
  RELIGION_BUDDHIST = 'religionBuddhist',
  RELIGION_CHRISTIAN = 'religionChristian',
  RELIGION_HINDU = 'religionHindu',
  RELIGION_JEWISH = 'religionJewish',
  RELIGION_MUSLIM = 'religionMuslim',
  RELIGION_SPIRITUAL = 'religionSpiritual',
