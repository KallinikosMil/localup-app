export default {
  ...
  profileViewReport: 'Report {{name}}',
  profileViewReportTitle: 'Report {{name}}',
  profileViewReportBody:
    'Tell us what is wrong. Reports are private — they are never told who reported them.',
  profileViewReportReasonUnderage: 'They appear to be under 18',
  profileViewReportReasonHarassment: 'Harassment or threats',
  profileViewReportReasonInappropriatePhotos: 'Inappropriate photos',
  profileViewReportReasonFakeProfile: 'Fake profile or impersonation',
  profileViewReportReasonSpam: 'Spam or scam',
